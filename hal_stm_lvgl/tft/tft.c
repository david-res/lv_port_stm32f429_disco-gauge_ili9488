...
void tft_init(void)
{
	...
	static lv_color_t disp_buf2[TFT_HOR_RES * 40];
	static lv_disp_buf_t buf;
	lv_disp_buf_init(&buf, disp_buf1, disp_buf2, TFT_HOR_RES * 40);
...
static void LCD_Config(void)
{
  ...
  /* Initialization of ili9488 component*/
  ili9488_Init();
...
/* LTDC Initialization -------------------------------------------------------*/
  ...
  /* Timing configuration  (Typical configuration from ili9488 datasheet)
      HSYNC=10 (9+1)
      HBP=20 (29-10+1)
  ...
  */
  ...
  LtdcHandle.Init.HorizontalSync = 2;
  LtdcHandle.Init.VerticalSync = 1;
  LtdcHandle.Init.AccumulatedHBP = 4;
  LtdcHandle.Init.AccumulatedVBP = 3;
  LtdcHandle.Init.AccumulatedActiveW = 324;
  LtdcHandle.Init.AccumulatedActiveH = 483;
  LtdcHandle.Init.TotalWidth = 327;
  LtdcHandle.Init.TotalHeigh = 485;
